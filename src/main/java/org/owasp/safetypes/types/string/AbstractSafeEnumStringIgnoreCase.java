...
public abstract class AbstractSafeEnumStringIgnoreCase extends AbstractSafeDataType<String> {

    protected AbstractSafeEnumStringIgnoreCase(String value) throws TypeValidationException {
        super(value);
    }
